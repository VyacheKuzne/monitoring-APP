...
const FormCreateCompany:React.FC<ModalBlockProps> = ({ closeForm }) => {
  ...
  return (
    ...
    <ModalWindow closeForm={closeForm}>
      <form className='flex flex-col gap-5 items-center' onSubmit={createCompany}>
        ...
        <button className="w-[50%] p-[5px] bg-slate-200 hover:bg-slate-300 rounded-[5px] text-[14px] font-montserrat transition" type="submit">
          Создать
        </button>
      </form>
    </ModalWindow>
