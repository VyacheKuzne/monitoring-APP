...
function CompanyInfo() {
  ...
  const createServer = async (event: React.FormEvent) => {
    ...
    try {
      ...
      await axios.post("http://89.104.65.22:3000/server/create", {
        idCompany: idCompany,
        name: domainName,
      });
          ...
          {Modal && (
            <div className="w-screen h-screen absolute flex justify-center items-center bg-color-fon z-10 top-0 left-0">
              ...
              <div className="bg-white  rounded-[5px] p-2 flex flex-col">
                ...
                <form
                  className="flex flex-col gap-5 items-center w-[450px] h-[150px"
                ...
                >
                  ...
                  <button
                    className="w-[50%] p-[5px]  bg-slate-300 hover:bg-slate-400 rounded-[5px] text-[14px] font-montserrat transition"
                    type="submit"
                  >
                    <p>Создать</p>
                  </button>
