...
function ServerInfo() {
  ...
  const getServerInfo = async () => {
    axios
      .get(`http://89.104.65.22:3000/company/${idCompany}/server/${idServer}/get`)
      .then((response) => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      const response = await axios.get(
        `http://89.104.65.22:3000/?domain=${domain}`,
      );
  ...
  const getAppInfo = async () => {
    try {
      const AppResponse = await axios.get(
        `http://89.104.65.22:3000/company/${idCompany}/server/${idServer}/app/get`,
      );
  ...
  const createDomain = async (event: React.FormEvent) => {
    ...
    try {
      ...
      await axios.post("http://89.104.65.22:3000/domain/create", {
